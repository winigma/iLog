 ...
 *
 */
@Controller("mBeanPesquisarFollowUpExterno")
@AccessScoped
public class MBeanPesquisarFollowUpExterno extends AbstractPaginacao {
	...
	private static Logger logger = LoggerFactory
			.getLogger(MBeanPesquisarFollowUpExterno.class);
