...
(function($) {
  $.ketchup = {
    defaults: {
      attribute           : 'title',                //look in that attribute for an validation string
    ...
    createErrorContainer: function(form, el) {      
      if(typeof form == 'function') {
        this.defaults.createErrorContainer = el;
        return this;
      } else {
        ...
        return $('<div/>', {
                 ...
                 css    : {
                	 	'z-index': '999',
                	 		'width': '125px',
                	  		position: 'absolute',
                            top : '-10px', //elOffset.top,
                            left: el.outerWidth() /2 //el.outerWidth() - 10,//elOffset.left //+ 50 + el.outerWidth() - 20
                          }
               }).insertBefore(el);
      }
    },
    ...
    showErrorContainer: function(form, el, container) {
      if(typeof form == 'function') {
        this.defaults.showErrorContainer = el;
        return this;
      } else {        
